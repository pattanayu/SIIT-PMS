<?php
/**
 * Template Name: ad-contract-form
...
if(get_the_title() == 'ad-contract-form'  )
{
get_header('admin');
}
else
...
<div class="container int">
	<form action="" method="post">
		<h2 style="padding: 10px; font-weight: bold;">Add Contract</h2>
		...
		<button class="btn btn-default" style=" margin-left:79%; margin-top: 10px;">Insert Image</button>
			...
			<div class="form-inline" style="margin-top: -80px;">
			 ...
			 <button type="submit" class="btn submit-button" style="margin-left: 30%; margin-top: 20px; margin-bottom: 20px;">Add</button>
